    ...
    <div className="about-wrapper">
      ...
      <div className="about-carlos">
        ...
        <p>
          ...
          Engineering.
          <br />
          <a href="https://github.com/cmm-7">>GitHub</a>
          <br />
          <a href="https://www.linkedin.com/in/cmendoza2792/">>LinkedIn</a>
        </p>
      </div>
      ...
      <div className="about-youssef">
        ...
        <p>
          ...
          <br />
          <a href="https://github.com/youssefmohamedfarouk">>GitHub</a>
          <br />
          <a href="https://www.linkedin.com/in/youssef-mohamed-farouk/">>LinkedIn</a>
        </p>
      </div>
    </div>
  );
